...
export const DEFAULT_EVENTS = {
  ...
  d4: [
    { id: 'p4a', time: '09:00', category: 'activity', title: '🏔️ Toro Verde Zip Lines & ATV Adventure', location: 'Toro Verde Nature Adventure Park, Orocovis, Puerto Rico', cost: 90, duration: 360, notes: '"The Monster" — longest zip line in Americas at 2.5km reaching 95mph!', links: [{ label: '🎟 Book', style: 'lk-book', url: 'https://toroverdepuertorico.com/' }] },
    { id: 'p4b', time: '14:00', category: 'rest',     title: '🏖️ Isla Verde Beach — Final Wind Down', location: 'Isla Verde Beach, San Juan, Puerto Rico', cost: 0, duration: 180, notes: 'Last beach day. Final piña coladas on the sand. 🌴', links: [] },
    { id: 'p4c', time: '18:00', category: 'party',    title: '⛵ Sunset Sailing Cruise with Open Bar', location: 'San Juan Bay, Old San Juan, Puerto Rico', cost: 70, duration: 180, notes: '2–3hr evening sail with live music, open bar & snacks. EPIC final night. 🥂', links: [{ label: '🎟 Book', style: 'lk-book', url: 'https://sailgetawaypuertorico.com/' }] },
    { id: 'p4d', time: '21:00', category: 'activity', title: '✨ Bioluminescent Bay Kayaking — Laguna Grande', location: 'Laguna Grande, Fajardo, Puerto Rico', cost: 45, duration: 120, notes: 'Water glows ELECTRIC BLUE when you paddle!', links: [{ label: '🎟 Book', style: 'lk-book', url: 'https://kayakingpuertorico.com/home/tours/bio-bay-kayak-tour/' }] },
  ],
}
